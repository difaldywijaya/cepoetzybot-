...
/////////////////
const BotName = 'Cepoetzybot☄'; 
const instagram = 'https://www.instagram.com/cepoetznieeh?igsh=MTMxdTN0Z3A2a2prdA==; 
const telegram = '-'; 
const kapanbotaktif = 'SELALU AKTIF 24 JAM KETIKA DIAKTIFKAN'; 
const youtube = '-';
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@Cepoetznieeh.id')
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by ig:@Cepoetznieeh.id`)
})
